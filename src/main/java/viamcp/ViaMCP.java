...
public class ViaMCP
{
    ...
    public static ExecutorService ASYNC_EXEC;
    ...
    public void start()
    {
        ...
        EVENT_LOOP.submit(this.INIT_FUTURE::join);
        ...
        final ViaManagerImpl viaManager = ViaManagerImpl.builder()
                .injector(new MCPViaInjector())
                .loader(new MCPViaLoader())
                .platform(new MCPViaPlatform(this.file))
                .build();
