...
public class DrawHelper extends GuiScreen {
  ...
  public static void draw2DImage(DynamicTexture image, int x, int y, int width, int height, Color c) {
    GlStateManager.enableTexture2D();
    image.updateDynamicTexture();
    final ResourceLocation location = Minecraft.getMinecraft().getTextureManager().getDynamicTextureLocation("puppy/wallpaper", image);
