...
import dev.isnow.puppy.hook.GuiInGameHook;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        FontHelper.bootstrap();
        Puppy.INSTANCE.monsoonFont = FontHelper.monsoon_regular;
        Puppy.INSTANCE.monsoonLargeFont = FontHelper.large;
        Puppy.INSTANCE.moonFont = FontHelper.moon;
...
//        this.ingameGUI = new GuiIngame(this);
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new MainMenuHook(), this, this.serverName, this.serverPort));
        }
        else
        {
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        if (guiScreenIn instanceof MainMenuHook)
        {
    ...
    private void rightClickMouse()
    {
        if (!this.playerController.func_181040_m())
        {
            ...
            {
                if(thePlayer.inventory.getCurrentItem() != null && Puppy.INSTANCE.toolBinds.get(thePlayer.inventory.getCurrentItem().getItem()) != null) {
                    thePlayer.sendChatMessage(Puppy.INSTANCE.toolBinds.get(thePlayer.inventory.getCurrentItem().getItem()));
                }
    ...
    public void runTick() throws IOException
    {
        ...
        if (this.currentScreen == null || this.currentScreen.allowUserInput)
        {
            ...
            while (Keyboard.next())
            {
                ...
                if(ScreenshotCommand.takess) {
                    ChatHelper.printMessage(ScreenShotHelper.saveScreenshot(this.mcDataDir, this.displayWidth, this.displayHeight, this.framebufferMc).getFormattedText());
                    ScreenshotCommand.hidden = false;
                    ScreenshotCommand.takess = false;
    ...
    public void dispatchKeypresses()
    {
        ...
        if (i != 0 && !Keyboard.isRepeatEvent())
        {
            if (!(this.currentScreen instanceof GuiControls) || ((GuiControls)this.currentScreen).time <= getSystemTime() - 20L)
            {
                if (Keyboard.getEventKeyState())
                {
                    if(Puppy.INSTANCE.keyToolBinds.containsKey(i) && thePlayer != null && this.currentScreen == null) {
                        thePlayer.sendChatMessage(Puppy.INSTANCE.keyToolBinds.get(i));
                    }
