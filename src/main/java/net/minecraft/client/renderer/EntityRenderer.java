...
public class EntityRenderer implements IResourceManagerReloadListener
{
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                if (OpenGlHelper.shadersSupported)
                {
                    ...
                    List<ShaderGroup> shaders = new LinkedList<>(); // linked list is more efficient here
                    ...
                    if(!mc.gameSettings.ofFastRender) {
                        if (motionBlur != null && MotionBlur.toggled)
                    ...
                    for (ShaderGroup shader : shaders) {
                        ...
                        GlStateManager.pushMatrix();
                        GlStateManager.loadIdentity();
                        shader.loadShaderGroup(p_181560_1_);
                        GlStateManager.popMatrix();
                    }
    ...
    private void frameInit()
    {
        ...
        if (this.mc.currentScreen instanceof MainMenuHook)
        {
            this.updateMainMenu((MainMenuHook)this.mc.currentScreen);
        }
    ...
    private void updateMainMenu(MainMenuHook p_updateMainMenu_1_)
    {
        try
        {
            String s = null;
            ...
            Field[] afield = MainMenuHook.class.getDeclaredFields();
