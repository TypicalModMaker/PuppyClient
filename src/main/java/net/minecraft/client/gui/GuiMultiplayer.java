...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    private String BungeeSpoofBtn() {
        return Puppy.INSTANCE.bungeeHack ? "Bungee: " + ColorHelper.color + "aYes" : "Bungee: " + ColorHelper.color + "cNo";
    }

    private String VersionBtn() {
        return Puppy.INSTANCE.autoVersion ? "AutoVersion: " + ColorHelper.color + "aYes" : "AutoVersion: " + ColorHelper.color + "cNo";
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.enabled)
        {
            ...
            else if (button.id == 1)
            {
                ...
                Puppy.INSTANCE.bungeeHack = !Puppy.INSTANCE.bungeeHack;
...
//                }
            ...
            {
                this.mc.displayGuiScreen(new GuiUUIDSpoof(this));
            }
        }
    }
    ...
    public void confirmClicked(boolean result, int id)
    {
        ...
        else if (this.directConnect)
        {
            ...
            if (result)
            {
                connectToServer(this, mc, this.selectedServer);
            }
            else
            {
                this.mc.displayGuiScreen(this);
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException
    {
        ...
        else
        {
            ...
            Puppy.INSTANCE.ipBungeeHack = IpBungeeBtn.getText();
        }
    }
    ...
    public void connectToSelected()
    {
        ...
        {
            connectToServer(this, mc, ((ServerListEntryNormal)guilistextended$iguilistentry).getServerData());
        }
        else if (guilistextended$iguilistentry instanceof ServerListEntryLanDetected)
        {
            ...
            connectToServer(this, mc, new ServerData(lanserverdetector$lanserver.getServerMotd(), lanserverdetector$lanserver.getServerIpPort(), true));
        }
    }

    public static void connectToServer(GuiScreen test, Minecraft mc, ServerData server)
    {
        Minecraft.getMinecraft().displayGuiScreen(new GuiConnecting(test, mc, server));
    }
