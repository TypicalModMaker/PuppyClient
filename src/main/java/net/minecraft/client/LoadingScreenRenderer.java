        ...
        else
        {
            ...
            if (i - this.systemTime >= 100L)
            {
                ...
                if(Puppy.INSTANCE.wallpaper != null) {
                    DrawHelper.draw2DImage(Puppy.INSTANCE.wallpaper, 0, 0, scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight(), new Color(0, 0, 0));
                } else {
                    Gui.drawRect(0,0,scaledresolution.getScaledWidth(), scaledresolution.getScaledHeight(), new Color(23,23,23).getRGB());
                }
